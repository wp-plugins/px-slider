			...
			<h3><?php _e("General Settings", 'pxslider'); ?></h3>
				<div class="inside" style="padding: 10px;">
					...
					<table class="pxs_admintbl">
						...
						<tr><td><?php _e("Custom Bg-Layer-1 URL",'pxslider'); ?></td><td><input type="text" class="pxs_uploadimg" name="pxslider_options[bg1url]" value="<?php echo $options['bg1url'] ?>" /><input class="pxs_uploadbtn" type="button" value="Browse.." /></td></tr>
						<tr><td><?php _e("Custom Bg-Layer-2 URL",'pxslider'); ?></td><td><input type="text" class="pxs_uploadimg" name="pxslider_options[bg2url]" value="<?php echo $options['bg2url'] ?>" /><input class="pxs_uploadbtn" type="button" value="Browse.." /></td></tr>
						<tr><td><?php _e("Custom Bg-Layer-3 URL",'pxslider'); ?></td><td><input type="text" class="pxs_uploadimg" name="pxslider_options[bg3url]" value="<?php echo $options['bg3url'] ?>" /><input class="pxs_uploadbtn" type="button" value="Browse.." /></td></tr>
